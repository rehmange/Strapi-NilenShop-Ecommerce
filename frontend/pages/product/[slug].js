...
// next js dynamic routing  search on google to show the each product data
// fetch by slug search on google straip fetch by slug and then make change the in postmen for product
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      ...
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        <h2 className="text-sm title-font text-gray-500 tracking-widest">NilenShop</h2>
        ...
        <div className="flex">
          <span className="title-font font-medium text-2xl text-gray-900">pkr{product.attributes.price}</span>
...
export async function getServerSideProps(context) {
    ...
    let headers = {Authorization: "Bearer "}

          ...
          <ul className='list-decimal px-8'>
            ...
            {cart.map((item) => {
              return <li key={item.id}>
                Product {item[0]} with a price of pkr{item[1]}
              </li>
            })}
          </ul>
        ...
        <div className=" ">
          <div className="flex flex-wrap -m-2">
            ...
            <div className="p-2 w-full">
              ...
              <Link href={`/success`}><button  className="flex text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Pay Now</button></Link>
            </div>
